...
-- SUPERUSER CODE
/*
CREATE USER osbe_repo WITH PASSWORD '159753';
CREATE DATABASE osbe_repo OWNER osbe_repo;
GRANT ALL PRIVILEGES ON DATABASE osbe_repo TO osbe_repo;
GRANT SELECT ON ALL TABLES IN SCHEMA public TO osbe_repo;
*/
